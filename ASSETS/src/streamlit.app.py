...
def home_page():
    ...
    <ul>
        ...
        <li>The Feature Importance Plot : This plot shows in descending order, the importance of each client feature.<li><li>Recommendations : Using the importance of client features, the marketing department is given recommendations to retain and gain clients.</li>
    </ul>
